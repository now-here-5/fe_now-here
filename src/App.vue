...
const showMainHeader = computed(() => route.path === '/' || route.path.startsWith('/match') || route.path === '/profile') // profile 추가
const showBottomNav = computed(() => route.path === '/' || route.path.startsWith('/match') || route.path === '/profile') // profile 추가
</script>

<style scoped lang="scss">
.main-container { //padding: 0 20px; 삭제
  width: 400px;
  min-height: 100vh;
  margin: 0 auto;
